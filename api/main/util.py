...
def destroy_tator_indices():
    ...
    with connection.cursor() as cursor:
        ...
        for table in ['main_media', 'main_localization', 'main_state']:
            count=0
            cursor.execute(f"SELECT indexname FROM pg_indexes WHERE indexname LIKE 'tator_%' AND tablename = '{table}'")
...
def make_simple_indices():
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_primary_section ON main_media (project, primary_section_id);")
        print("Created index simple_media_project_primary_section on main_media (project, primary_section_id)")

        # create an index on project and media id
        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_media_project_id_id;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_id_id ON main_media (project, id);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_name ON main_media (project, name);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_name_gin ON main_media USING gin (name gin_trgm_ops);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_name_upper ON main_media (project, upper(name));")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_media_project_name_upper_gin ON main_media USING gin (upper(name) gin_trgm_ops);")
        print("Created index simple_media_project_name_upper_gin on main_media (upper(name) gin_trgm_ops)")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_section_project_name ON main_section (project, name);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_section_project_name_gin ON main_section USING gin (name gin_trgm_ops);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_section_project_name_upper ON main_section (project, upper(name));")
        print("Created index simple_section_project_name_upper on main_section (project, upper(name))")

        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_section_project_name_upper_gin;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_section_project_name_upper_gin ON main_section USING gin (upper(name) gin_trgm_ops);")
        print("Created index simple_section_project_name_upper_gin on main_section (upper(name) gin_trgm_ops)")

        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_section_project_path;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_section_project_path ON main_section USING gist (path gist_ltree_ops(siglen=16));")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_leaf_project_name ON main_leaf (project, name);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_leaf_project_name_gin ON main_leaf USING gin (name gin_trgm_ops);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_leaf_project_name_upper ON main_leaf (project, upper(name));")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_leaf_project_name_upper_gin ON main_leaf USING gin (upper(name) gin_trgm_ops);")
        print("Created index simple_leaf_project_name_upper_gin on main_leaf (upper(name) gin_trgm_ops)")

        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_leaf_project_path;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_leaf_project_path ON main_leaf USING gist (path gist_ltree_ops(siglen=16));")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_project_media ON main_localization (project, media);")
        print("Created index simple_localization_project_media on main_localization (project, media)")

        # create an index for localization on a project by media and version
        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_localization_project_media_version;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_project_media_version ON main_localization (project, media, version);")
        print("Created index simple_localization_project_media_version on main_localization (project, media, version)")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_project_type ON main_localization (project, meta);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_latest_mark ON main_localization (project, ((mark=latest_mark)));")
        print("Created index simple_localization_latest_mark on main_localization (project, ((mark=latest_mark)))")

        # create a GIN-index for elemental_id
        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_localization_elemental_id_gin;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_elemental_id_gin ON main_localization USING gin ((elemental_id::text) gin_trgm_ops);")
        print("Created index simple_localization_elemental_id on main_localization (elemental_id::text gin_trgm_ops)")

        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_localization_elemental_id;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_localization_elemental_id ON main_localization USING btree ((elemental_id::text));")
        print("Created index simple_localization_elemental_id on main_localization (elemental_id::text)")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_state_project_version ON main_state (project, version);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_state_project_type ON main_state (project, meta);")
        ...
        cursor.execute("CREATE INDEX CONCURRENTLY simple_state_latest_mark ON main_state (project, ((mark=latest_mark)));")
        print("Created index simple_state_latest_mark on main_state (project, ((mark=latest_mark)))")

        # Create an index for elemental_id
        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_state_elemental_id_gin;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_state_elemental_id_gin ON main_state USING gin ((elemental_id::text) gin_trgm_ops);")
        print("Created index simple_state_elemental_id_gin ON main_state USING gin (elemental_id::text gin_trgm_ops);")

        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS simple_state_elemental_id;")
        cursor.execute("CREATE INDEX CONCURRENTLY simple_state_elemental_id ON main_state USING btree ((elemental_id::text));")
...
def make_curated_indices():
    ...
    with connection.cursor() as cursor:
        ...
        attribute_names=["ScientificName", "Scientific Name", "Label", "Species", "Subspecies", "Animal Name", "Category"]
        table_names="main_localization", "main_state"
        for table in table_names:
            for attribute in attribute_names:
                no_spaces = attribute.replace(" ", "_")
                # UPPER
                cursor.execute(f"DROP INDEX CONCURRENTLY IF EXISTS curated_{table}_project_{no_spaces}_upper;")
                cursor.execute(f"CREATE INDEX CONCURRENTLY curated_{table}_project_{no_spaces}_upper ON {table} (project, upper(attributes->>'{attribute}'));")
                print(f"Created index curated_{table}_project_{no_spaces}_upper on {table} (project, upper(attributes->>'{attribute}'))")

                # btree
                cursor.execute(f"DROP INDEX CONCURRENTLY IF EXISTS curated_{table}_project_{no_spaces};")
                cursor.execute(f"CREATE INDEX CONCURRENTLY curated_{table}_project_{no_spaces} ON {table} (project, (attributes->>'{attribute}'));")
                print(f"Created index curated_{table}_project_{no_spaces} on {table} (project, attributes->>'{attribute}')")


                # GIN - Upper
                cursor.execute(f"DROP INDEX CONCURRENTLY IF EXISTS curated_{table}_project_{no_spaces}_upper_gin;")
                cursor.execute(f"CREATE INDEX CONCURRENTLY curated_{table}_project_{no_spaces}_upper_gin ON {table} USING gin (upper(attributes->>'{attribute}') gin_trgm_ops);")
                print(f"Created index curated_{table}_project_{no_spaces}_upper_gin on {table} (upper(attributes->>'{attribute}') gin_trgm_ops)")

                # GIN 
                cursor.execute(f"DROP INDEX CONCURRENTLY IF EXISTS curated_{table}_project_{no_spaces}_gin;")
                cursor.execute(f"CREATE INDEX CONCURRENTLY curated_{table}_project_{no_spaces}_gin ON {table} USING gin ((attributes->>'{attribute}') gin_trgm_ops);")
                print(f"Created index curated_{table}_project_{no_spaces}_gin on {table} ({attribute} gin_trgm_ops)")
