    ...
    def get_schema(self, request=None, public=True, parser=False):
        ...
        schema["components"] = {
            "schemas": {
                ...
                "GroupUpdateSpec": group_update_spec,
                ...
                "RowProtection": row_protection,
                "RowProtectionSpec": row_protection_spec,
                "RowProtectionUpdateSpec": row_protection_update_spec,
                "S3StorageConfig": s3_storage_config,
                "SectionSpec": section_spec,
                "SectionBulkUpdate": bulk_section_update,
