...
FROM cvisionai/svt_encoder:v0.0.4 as builder
ENV LANG C.UTF-8
...
RUN pip3 --no-cache-dir --timeout=1000 install pillow==6.2.1 imageio==2.6.1 progressbar2==3.47.0 boto3==1.14.19 pandas==1.1.0
