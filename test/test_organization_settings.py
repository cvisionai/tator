...
def test_organization_settings(page_factory, project, launch_time, image_file, base_url):
    ...
    page.fill('org-type-form-container[form="bucket-edit"] text-area[name="Config"] textarea', '{"aws_access_key_id": "123456", "aws_secret_access_key": "ABCDEFG", "endpoint_url": "https://www.google.com", "region_name": "Northeast"}')
    ...
    page.fill(f'org-type-form-container[form="bucket-edit"] text-area[name="Config"] textarea', '{"aws_access_key_id": "NewKey654321", "aws_secret_access_key": "HIJKLMN", "endpoint_url": "https://www.bing.com", "region_name": "Southwest"}')
