...
def test_organization_settings(page_factory, project, launch_time, image_file, base_url):
    ...
    page.fill('org-type-form-container[form="bucket-edit"] text-input[name="Access Key"] input', f"123456")
    page.fill('org-type-form-container[form="bucket-edit"] text-input[name="Secret Key"] input', f"ABCDEFG")
    page.fill('org-type-form-container[form="bucket-edit"] text-input[name="Endpoint URL"] input', f"https://www.google.com/")
    page.fill('org-type-form-container[form="bucket-edit"] text-input[name="Region"] input', f"Northeast")
    ...
    page.fill(f'org-type-form-container[form="bucket-edit"] text-input[name="Access Key"] input', f"NewKey654321")
    ...
    page.click('#nav-for-Bucket #sub-nav--plus-link')
    page.fill('org-type-form-container[form="bucket-edit"] text-input[name="Name"] input', f"Bucket GCS Testing")
    page.click('text="GCS"')
    ...
    page.fill('org-type-form-container[form="bucket-edit"] text-area[name="GCS Key Info"] textarea', '{"auth_provider_x509_cert_url":"https://www.google.com/","auth_uri":"https://www.google.com/","client_email":"test@test.com","client_id":"123456789","client_x509_cert_url":"https://www.google.com/","private_key":"-----BEGIN RSA PRIVATE KEY-----\nProc-Type: 4,ENCRYPTED\nDEK-Info: DES-EDE3-CBC,68A2F29F585C18F1\n\\n-----END RSA PRIVATE KEY-----","private_key_id":"123456789","project_id":"1","token_uri":"https://www.google.com/","type":"service_account"}')
    url = base_url + "/rest/Buckets/" + str(organization_id)
    # with page.expect_response(url) as response_info:
