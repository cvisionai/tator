...
export class LeafItem extends TatorElement {
   constructor() {
      ...
      this.leafCurrent.setAttribute("class", "d-flex flex-row f1 flex-items-center flex-justify-between");
      leafItem.appendChild(this.leafCurrent);

      this.addChildLeafIndent = document.createElement("span");
      this.addChildLeafIndent.setAttribute("class","d-flex flex-row")
   ...
   _init(leaf, leafMain) {
      ...
      if (leaf.expands) this.maximizeIcon.hidden = false;
