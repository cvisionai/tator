...
export class AnnotationPage extends TatorPage {
  constructor() {
    ...
    this._cameraSelectionBar.setAttribute(
      "class",
      "ml-2 px-2 py-1 box-border rounded-2 flex-items-center"
    );
    ...
    this._appletShortcutBar.setAttribute(
      "class",
      "ml-2 px-2 py-1 box-border rounded-2"
    );
