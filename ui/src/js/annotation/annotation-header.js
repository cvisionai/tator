...
export class AnnotationHeader extends TatorElement {
  constructor() {
    ...
    this._titleText.setAttribute("class", "d-flex flex-row flex-items-center h3 text-white py-2 px-2");
    this._titleText.style.margin = "auto";
    header.appendChild(this._titleText);

    this._close = document.createElement("button");
    this._close.setAttribute("class", "px-3 py-1 d-flex flex-items-center f4 text-uppercase text-gray annotation-subheader-close");
