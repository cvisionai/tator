...
export class QualityControl extends TatorElement {
  constructor() {
    super();
    ...
    const advancedSettingsTitle = document.createElementNS(
      svgNamespace,
      "title"
    );
    ...
    advancedSettingsPath.setAttribute(
      "d",
