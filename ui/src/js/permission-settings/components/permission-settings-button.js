...
class QuestionMarkButton extends PermissionSettingsButton {
  constructor() {
    super();
    this.init(
      "",
...
class PermissionCalculatorButton extends PermissionSettingsButton {
  constructor() {
    super();
    this.init(
...
class DisallowPermissionButton extends PermissionSettingsButton {
  constructor() {
    super();
    this.init(
      "Disallow All Permission",
      "M384 208C401.7 208 416 222.3 416 240V272C416 289.7 401.7 304 384 304H128C110.3 304 96 289.7 96 272V240C96 222.3 110.3 208 128 208H384zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z",
      "0 0 512 512"
    );
  }
...
customElements.define("question-mark-button", QuestionMarkButton);
customElements.define(
  "permission-calculator-button",
  PermissionCalculatorButton
);
customElements.define("disallow-permission-button", DisallowPermissionButton);
