...
((name, definition) => {
  ...
  const streamSaver = {
    ...
    mitm: "/stream-saver/mitm.html", // Updated URL to work on tator
    // Reference url: https://jimmywarting.github.io/StreamSaver.js/mitm.html?version=2.0.0
  };
  ...
  function makeIframe(src) {
    ...
    iframe.loaded = false;
    iframe.name = "iframe";
    iframe.setAttribute("crossorigin", "anonymous"); // Added to work on tator with COEP
