...
export class ProjectRemove extends TatorElement {
  constructor() {
    super();

    const button = document.createElement("button");
    button.setAttribute("class", "px-2 btn-clear h3 text-gray hover-text-white");
...
customElements.define("project-remove", ProjectRemove);
