  ...
  subscribeWithSelector((set, get) => ({
    ...
    init: async () => {
      Promise.all([
        ...
        fetchCredentials(`/rest/Organization/${organizationId}`, {}, true).then(
    ...
    setOrganizationData: async (id) => {
      ...
      const object = await fetchWithHttpInfo(
    ...
    getUser: async (username) => {
      if (get().Affiliation.usernameToUserMap.has(username)) {
        ...
        try {
          ...
          const responseInfo = await fetchWithHttpInfo(
