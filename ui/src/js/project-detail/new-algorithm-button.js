class NewAlgorithmButton extends TatorElement {
  constructor() {
    super();

    const button = document.createElement("button");
    button.setAttribute("class", "btn-clear py-2 px-0 f3 text-purple hover-text-white text-uppercase d-flex flex-items-center");
