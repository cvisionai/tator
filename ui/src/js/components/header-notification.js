...
export class HeaderNotification extends TatorElement {
  constructor() {
    super();

    this._span = document.createElement("span");
    this._span.setAttribute("class", "header__notification d-flex py-2 px-2 rounded-1");
    this._shadow.appendChild(this._span);

    this._text = document.createElement("span");
    this._text.setAttribute("class", "px-1");
    this._span.appendChild(this._text);
  }

  static get observedAttributes() {
    return ["text", "with-check"];
  }
