...
class LocalizationTypeListAPI(BaseListView):
    ...
    def _get(self, params):
        ...
        if media_id != None:
            ...
            localizations = LocalizationType.objects.filter(media__in=media_id[0])
            ...
            response_data = LocalizationType.objects.filter(project=self.kwargs['project']).values(*fields)
