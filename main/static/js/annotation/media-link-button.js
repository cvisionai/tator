class MediaLinkButton extends TatorElement {
  constructor() {
    super();
    ...
    button.addEventListener("click", () => {
      ...
      setTimeout(() => {this._shadow.removeChild(div)}, 3000);
    });
  }
}
