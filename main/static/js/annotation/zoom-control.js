class ZoomControl extends TatorElement {
  constructor() {
    super();

    const zoomDiv = document.createElement("div");
    zoomDiv.setAttribute("class", "annotation__setting d-flex flex-items-center px-1 rounded-1");
    this._shadow.appendChild(zoomDiv);

    const minus = document.createElement("button");
    minus.setAttribute("class", "btn-clear d-flex rounded-1 f2 text-gray hover-text-white");
    ...
    plus.setAttribute("class", "btn-clear d-flex rounded-1 f2 text-gray hover-text-white");
