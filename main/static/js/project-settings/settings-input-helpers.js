...
class SettingsInput {
  ...
  inputText({
    ...
    labelForColor.innerHTML = "Default: "
    ...
    //
    colorInput.setAttribute("class", "float-left col-md-9 col-sm-12 dflex");
    ...
    // 
    unspecColorInput.setAttribute("class", "float-left col-md-3 col-sm-12");
