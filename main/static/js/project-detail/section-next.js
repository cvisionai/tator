class SectionNext extends TatorElement {
  constructor() {
    super();

    this._button = document.createElement("button");
    this._button.setAttribute("class", "files__next d-flex flex-items-center px-0 btn-clear text-uppercase text-purple hover-text-white");
